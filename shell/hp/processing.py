...
def PDBparser(pdbdir,MDL=0,write=1):
    import warnings
    ...
    if write == 1:
        ...
        io.save('%s/%s_mdl0.pdb' % (pdbpath,pdbid), ModelSelect(), preserve_atom_numbering=True)
    return model
