...
if __name__ == '__main__':
    ...
    parser.add_argument('pdbdir',            type=str,  help='The input directory of a .pdb file')
    parser.add_argument('chain',             type=str,  help='The mutation chian')
    parser.add_argument('position',          type=str,  help='The mutation position')
