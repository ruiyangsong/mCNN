...
def data():
    ...
    data_1 = np.load('/dl/sry/mCNN/dataset/S2648/feature/mCNN/wild/npz/center_CA_PCA_False_neighbor_80.npz')
    ...
    data_2 = np.load('/dl/sry/mCNN/dataset/S2648/feature/mCNN/mutant/npz/center_CA_PCA_False_neighbor_80.npz')
    x = data_2['x']
    y = data_2['y']
    train_num = x.shape[0]
    indices = [i for i in range(train_num)]
