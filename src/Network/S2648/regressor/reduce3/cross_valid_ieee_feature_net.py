...
def ieee_net(x_train, y_train, ddg_train, x_test, y_test, ddg_test, x_val, y_val, ddg_val, class_weights_dict):
...
if __name__ == '__main__':
    ...
    for i in range(5):
        ...
        model, history_dict = ieee_net(x_train, y_train, ddg_train, x_test, y_test, ddg_test, x_val, y_val, ddg_val, class_weights_dict)
        try:
