...
from metrics_bak import test_report_reg, pearson_r
...
def Conv2DRegressorIn1(x_train, y_train, ddg_train, x_test, y_test, ddg_test, class_weights_dict,obj,kneighbor):
        K.clear_session()
        summary = False
        verbose = 1
        # setHyperParams------------------------------------------------------------------------------------------------
